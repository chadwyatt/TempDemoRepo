...
class Admin {
	...
	public function enqueue_admin_styles($hook) {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			// wp_enqueue_style( $this->plugin_slug . '-bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css', array(), $this->version );
		}
	}
	...
	public function enqueue_admin_scripts() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			// wp_enqueue_script( $this->plugin_slug . '-bootstrap', 'https://unpkg.com/react/umd/react.production.min.js', array( 'jquery' ), $this->version );
	...
	public function add_plugin_admin_menu() {
		...
		// 	__( 'Voicemail Drops', $this->plugin_slug ),
		// 	__( 'Voicemail Drops', $this->plugin_slug ),
		// 	'manage_options',
		// 	$this->plugin_slug,
	...
	public function display_plugin_admin_page() {
		?><div id="profital-plugins-vmd-admin"></div><?php
	}
